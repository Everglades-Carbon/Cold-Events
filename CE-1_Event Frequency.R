...
par(mfrow=c(1,1), tck=0.02, cex=1.2)
...
text(1,7, "EVG", col="dimgrey")
text(2,5.8, "RPR", col="dimgrey")
text(3,4.8, "FLG", col="dimgrey")
text(4,0, "TAV", col="dimgrey")
...
text(3.5, 9, labels=r2.label)
text(3.5, 8.5, labels=p.val)
